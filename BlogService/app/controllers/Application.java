...
public class Application extends Controller {
    ...
    public Result signup() {
        ...
        if(existingUser != null) {
            return badRequest(commonUtils.buildJsonResponse("error", "User exists"));
        } else {
            User user = new User();
            ...
            return ok(commonUtils.buildJsonResponse("success", "User created successfully"));
        }
    }
    ...
    public Result login() {
        ...
        if(user == null) {
            return badRequest(commonUtils.buildJsonResponse("error", "Incorrect email or password"));
        } else {
            session().clear();
    ...
    public Result logout() {
        session().clear();
        return ok(commonUtils.buildJsonResponse("success", "Logged out successfully"));
    }
    ...
    public Result getPost(Long id) {
        ...
        if(blogPost == null) {
            return notFound(commonUtils.buildJsonResponse("error", "Post not found"));
        }
